...
@click.option(
    ...
    type=click.File("rt"),
    required=True,
    help="Merizo results file path (TSV)",
)
@click.option(
    "--unidoc",
    "-u",
    ...
    type=click.File("rt"),
    required=True,
    help="UniDoc results file path (TSV)",
)
@click.option(
    "--chainsaw",
    "-c",
    ...
    type=click.File("rt"),
    required=True,
    help="Chainsaw results file path (TSV)",
)
@click.option(
    "--output", "-o", "output_file", required=True, help="Output result file path (TSV)"
)
